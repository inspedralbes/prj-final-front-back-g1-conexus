...
(1, 'Laura Puig', 'laura.puig@example.com', 'laurapuig', '/upload/banner_default.png', '/upload/profile_default.png', 'Sóc una persona amb moltes ganes d’aprendre i millorar les meves habilitats. M’apassiona la tecnologia i vull aprofitar aquesta oportunitat per créixer professionalment.', 'Barcelona, Espanya', '["JavaScript", "Python", "React"]', '{"monday": "9-5", "tuesday": "9-5", "wednesday": "9-5", "thursday": "9-5", "friday": "9-5"}', true, 'approved', 4.2, 19),
(1, 'Martí Vila', 'marti.vila@example.com', 'martivila', '/upload/banner_default.png', '/upload/profile_default.png', 'Estic molt interessat en el desenvolupament de programari i vull millorar les meves habilitats en aquest camp. M’agrada treballar en projectes pràctics i col·laborar amb altres persones.', 'Girona, Espanya', '["Java", "C#", "SQL"]', '{"monday": "10-6", "wednesday": "10-6", "friday": "10-6"}', true, 'approved', 3.9, 17),
(1, 'Gemma Riera', 'gemma.riera@example.com', 'gemmariera', '/upload/banner_default.png', '/upload/profile_default.png', 'M’apassiona el món de la programació i vull aprendre noves tecnologies per poder aplicar-les en projectes reals. Sóc una persona molt motivada i amb ganes de superar-me.', 'Tarragona, Espanya', '["PHP", "MySQL", "Laravel"]', '{"monday": "8-4", "tuesday": "8-4", "thursday": "8-4", "friday": "8-4"}', true, 'approved', 4.3, 24),
(1, 'Oriol Serra', 'oriol.serra@example.com', 'oriolserra', '/upload/banner_default.png', '/upload/profile_default.png', 'Sóc un apassionat de la tecnologia i vull millorar les meves habilitats en desenvolupament web. M’agrada treballar en equip i compartir coneixements amb altres persones.', 'Lleida, Espanya', '["JavaScript", "Node.js", "Express"]', '{"monday": "9-5", "tuesday": "9-5", "wednesday": "9-5", "friday": "9-5"}', true, 'approved', 4.1, 15),
(1, 'Anna Martí', 'anna.marti@example.com', 'annamarti', '/upload/banner_default.png', '/upload/profile_default.png', 'Tinc moltes ganes d’aprendre i millorar les meves habilitats en desenvolupament de programari. M’agrada treballar en projectes pràctics i col·laborar amb altres persones per assolir objectius comuns.', 'Barcelona, Espanya', '["Ruby", "Rails", "JavaScript"]', '{"monday": "10-6", "tuesday": "10-6", "wednesday": "10-6", "thursday": "10-6"}', true, 'approved', 4.4, 23),
(1, 'Pau Ferrer', 'pau.ferrer@example.com', 'pauferrer', '/upload/banner_default.png', '/upload/profile_default.png', 'M’agrada molt la programació i vull aprendre més sobre desenvolupament web i aplicacions mòbils.', 'València, Espanya', '["HTML", "CSS", "JavaScript"]', '{"monday": "9-5", "tuesday": "9-5", "wednesday": "9-5", "thursday": "9-5", "friday": "9-5"}', true, 'approved', 4.0, 20),
(1, 'Carla López', 'carla.lopez@example.com', 'carlalopez', '/upload/banner_default.png', '/upload/profile_default.png', 'Estic interessada en el disseny gràfic i vull millorar les meves habilitats en aquest camp.', 'Madrid, Espanya', '["Photoshop", "Illustrator", "InDesign"]', '{"monday": "10-6", "tuesday": "10-6", "wednesday": "10-6", "thursday": "10-6"}', true, 'approved', 4.5, 21),
(1, 'Jordi Soler', 'jordi.soler@example.com', 'jordisoler', '/upload/banner_default.png', '/upload/profile_default.png', 'M’apassiona la intel·ligència artificial i vull aprendre més sobre aquest camp.', 'Sevilla, Espanya', '["Python", "TensorFlow", "Keras"]', '{"monday": "8-4", "tuesday": "8-4", "wednesday": "8-4", "thursday": "8-4"}', true, 'approved', 4.6, 22),
(1, 'Marta Vidal', 'marta.vidal@example.com', 'martavidal', '/upload/banner_default.png', '/upload/profile_default.png', 'Vull millorar les meves habilitats en desenvolupament de videojocs i aprendre noves tècniques.', 'Bilbao, Espanya', '["Unity", "C#", "Blender"]', '{"monday": "9-5", "tuesday": "9-5", "wednesday": "9-5", "thursday": "9-5"}', true, 'approved', 4.3, 23),
(1, 'Albert Gómez', 'albert.gomez@example.com', 'albertgomez', '/upload/banner_default.png', '/upload/profile_default.png', 'M’interessa el desenvolupament de software i vull aprendre més sobre aquest camp.', 'Zaragoza, Espanya', '["Java", "Spring", "Hibernate"]', '{"monday": "10-6", "tuesday": "10-6", "wednesday": "10-6", "thursday": "10-6"}', true, 'approved', 4.2, 24);
