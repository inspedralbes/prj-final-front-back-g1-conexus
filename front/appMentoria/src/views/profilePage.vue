<template>
  ...
  <div class="bg-gray-800 text-gray-100 p-6 rounded-xl shadow-lg max-w-3xl mx-auto">
    <h2 class="text-xl font-semibold border-b border-gray-600 pb-2 mb-4">Personal Information</h2>
    <div class="space-y-4">
      <!-- Full Name -->
      <div>
        <h3 class="text-sm font-semibold text-gray-400">Full name</h3>
        <p class="text-base">Joseph McFall</p>
      </div>

      <!-- Biography -->
      <div>
        <h3 class="text-sm font-semibold text-gray-400">Biography</h3>
        <p class="text-base">
          I am Joseph McFall, a fervent explorer navigating the intricate landscapes of web design, driven by an
          unyielding passion for Web 3 and Artificial Intelligence. From the early days of tinkering with computers to
          my current standing as a web designer, my journey has been a dynamic evolution marked by a relentless pursuit
          of innovation.
        </p>
      </div>
