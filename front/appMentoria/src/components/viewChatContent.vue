  ...
  <div class="flex flex-col h-screen dark:bg-neutral-900">
    <div class="flex sm:items-center justify-between py-2 border-b-2 border-gray-200">
      ...
      <div class="flex items-center space-x-2 pr-4">
        <button @click="$emit('closeChat')" type="button" class="inline-flex items-center justify-center rounded-lg h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
  ...
  <div v-for="(interaction, index) in interactions" :key="index" class="chat-message">
    ...
    <div class="border-t-2 border-gray-200 px-4 p-4 mb-2 sm:mb-0">
      <div class="relative flex">
        <input ref="messageInput" type="text" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-5 pr-20 bg-gray-200 rounded-md py-3 dark:bg-gray-800 dark:text-white" />
        <div class="absolute right-0 items-center inset-y-0 flex">
          <button @click="sendMessageInMongoNow" type="button" class="inline-flex items-center justify-center rounded-full h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none mr-4">
