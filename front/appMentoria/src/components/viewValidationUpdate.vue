      ...
      >
        <div class="flex flex-wrap justify-between mb-4">
          ...
          <div class="w-full md:w-1/2 mb-4 md:mb-0">
            ...
            >
              <option value="1">{{ $t("ViewValidationUpdate.student") }}</option>
              <option value="2">{{ $t("ViewValidationUpdate.teacher") }}</option>
              <option value="3">{{$t("ViewValidationUpdate.admin")}}</option>
            </select>
          </div>
        </div>
        <div class="mb-5">
          <p class="text-sm font-semibold text-gray-700 dark:text-gray-100">
            {{ $t("ViewValidationUpdate.class") }}:
          </p>
        ...
        <div class="mb-5">
          <p class="text-sm font-semibold text-gray-700 dark:text-gray-100">
            {{ $t("ViewValidationUpdate.profile") }}
          </p>
          <img
            :src="user.profile"
            alt="User Profile"
        ...
        <div class="flex justify-end">
          ...
          >
            {{ $t("ViewValidationUpdate.validate") }}
          </button>
          <button
