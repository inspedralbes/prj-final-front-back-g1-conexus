    ...
    <div class="bg-slate-900/10 backdrop-blur-sm rounded-xl p-6 shadow-2xl animate-fade-in border border-slate-700/30">
        ...
        <div v-else class="space-y-4">
            <div v-for="report in filteredReports" :key="report.id"
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-gray-400 text-sm mt-1">
                            <span class="text-gray-500">Usuari:</span> {{ report.User?.name || 'Desconegut' }}
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button @click="deleteReport(report.id)" 
                            class="text-red-400 hover:text-red-300 p-1 transition-colors duration-300">
                ...
                <!-- Assignació i data -->
                <div class="mt-4 pt-3 border-t border-slate-700/50 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                    <div class="flex items-center">
                        ...
                        <button 
                            ...
                            class="bg-blue-500/90 hover:bg-blue-600 text-white px-3 py-1 text-sm rounded-lg transition-colors duration-300 flex items-center">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
